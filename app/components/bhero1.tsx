      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          <Image
            ...
            alt="Classic apparel background"
            fill
      ...
      <div className="relative z-10 flex items-center h-full max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            ...
            <div className="absolute -inset-0.5 border border-dove-ivory/50 -z-10" style={{ transform: 'translateZ(-3px)' }} />
            <div className="absolute -inset-1 border border-dove-ivory/30 -z-20" style={{ transform: 'translateZ(-6px)' }} />
            
            {/* Illuminate border edges */}
            <div 
              className="absolute inset-0 border-2 border-dove-gold/30"
...
// Shop Now button with illuminating effect
