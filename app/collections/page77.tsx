...
const Collections: React.FC = () => {
  ...
  // State for collections and filters
  const [displayedItems, setDisplayedItems] = useState(6); // Initial items
  const [categoryFilter, setCategoryFilter] = useState<string>('All');
  const [priceFilter, setPriceFilter] = useState<string>('All');

  // Sample collection items (expanded)
  ...
  // Filter collections based on category and price
  const filteredCollections = allCollections.filter((item) => {
    const matchesCategory = categoryFilter === 'All' || item.category === categoryFilter;
    const matchesPrice =
      priceFilter === 'All' ||
      (priceFilter === '0-50' && item.priceRange === '0-50') ||
      (priceFilter === '50-100' && item.priceRange === '50-100') ||
      (priceFilter === '100+' && item.priceRange === '100+');
  ...
  // Hover animation for 3D tilt and glow
  const tiltVariants = {
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            {['All', 'Womens', 'Mens', 'Accessories', 'Kids', 'Footwear'].map((cat) => (
              <motion.button
                key={cat}
            ...
            <Link key={item.id} href={item.link}>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    backgroundImage: `url('/images/ankara-pattern.png')`, // Replace with actual pattern
        ...
        {displayedItems < filteredCollections.length && (
          <div ref={loadMoreRef} className="h-10 mt-8"></div>
        )}
